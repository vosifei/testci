...
run_install() {
  ...
  sed -i -e "s/.*gem \"sqlite3\", :platforms => \[:mri, :mingw, :x64_mingw\].*/        gem \"sqlite3\", (RUBY_VERSION < \"2.0\" \&\& RUBY_PLATFORM =~ \/mingw\/ ? \"1.3.12\" : \"~>1.3.12\"),:platforms => [:mri, :mingw, :x64_mingw]/" ./Gemfile
  cat ./Gemfile
